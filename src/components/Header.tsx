...
import avatar from "../metronic/media/avatars/300-2.png";

function Header() {

  return <header
  className="header bg-white border border-b-1 fixed top-0 z-10 left-0 right-0 flex items-stretch shrink-0 dark:bg-coal-500"
  data-sticky="true"
...
>
  ...
  >
    ...
    <div className="flex items-center gap-2 lg:gap-3.5">
      ...
      >
        <svg className="size-5" width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="dropdown-content light:border-gray-300 w-full max-w-[450px]">
          <div className="">
            <div className="flex items-center justify-between gap-2.5 text-sm text-gray-900 font-semibold px-5 py-2.5">
              ...
              >
                <svg className="size-5" width="800px" height="800px" viewBox="-0.5 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M6.5 10.32C8.433 10.32 10 8.753 10 6.82001C10 4.88701 8.433 3.32001 6.5 3.32001C4.567 3.32001 3 4.88701 3 6.82001C3 8.753 4.567 10.32 6.5 10.32Z" stroke="#000000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M17.5 10.32C19.433 10.32 21 8.753 21 6.82001C21 4.88701 19.433 3.32001 17.5 3.32001C15.567 3.32001 14 4.88701 14 6.82001C14 8.753 15.567 10.32 17.5 10.32Z" stroke="#000000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M6.5 21.32C8.433 21.32 10 19.753 10 17.82C10 15.887 8.433 14.32 6.5 14.32C4.567 14.32 3 15.887 3 17.82C3 19.753 4.567 21.32 6.5 21.32Z" stroke="#000000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M17.5 21.32C19.433 21.32 21 19.753 21 17.82C21 15.887 19.433 14.32 17.5 14.32C15.567 14.32 14 15.887 14 17.82C14 19.753 15.567 21.32 17.5 21.32Z" stroke="#000000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </button>
            </div>
                  ...
                  <div className="flex -space-x-2">
                    <div className="flex">
                      <img
                        ...
                        src="../metronic/media/avatars/300-4.png"
                      />
                    </div>
                    <div className="flex">
                      <img
                        className="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]"
                        src="../metronic/media/avatars/300-1.png"
                      />
                    </div>
                    <div className="flex">
                      <img
                        className="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]"
                        src="../metronic/media/avatars/300-2.png"
                      />
                    </div>
                    <div className="flex">
            ...
            <div className="flex flex-col gap-5 py-5">
              <div className="flex items-end gap-3.5 px-5">
                <img
                  ...
                  src="../metronic/media/avatars/300-5.png"
                />
                <div className="flex flex-col gap-1.5">
            ...
            >
              <div className="relative shrink-0">
                <img
                  ...
                  src="../metronic/media/avatars/300-14.png"
                />
                  ...
                  >
                    <div className="relative shrink-0 mt-0.5">
                      <img
                        alt=""
                        className="rounded-full size-8"
                        src="../metronic/media/avatars/300-27.png"
                      />
                      <span className="size-1.5 badge badge-circle bg-gray-400 absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2"></span>
                    </div>
                    <div className="flex flex-col gap-3.5">
                  ...
                  <div className="flex grow gap-2.5 px-5">
                    <div className="relative shrink-0 mt-0.5">
                      <img
                        alt=""
                        className="rounded-full size-8"
                        src="../metronic/media/avatars/300-11.png"
                      />
                      <span className="size-1.5 badge badge-circle badge-success absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2"></span>
                    </div>
                    <div className="flex flex-col gap-1">
                  ...
                  >
                    <div className="relative shrink-0 mt-0.5">
                      <img
                        alt=""
                        className="rounded-full size-8"
                        src="../metronic/media/avatars/300-25.png"
                      />
                      <span className="size-1.5 badge badge-circle badge-success absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2"></span>
                    </div>
                    <div className="flex flex-col gap-3.5 grow">
                  ...
                  <div className="flex grow gap-2.5 px-5">
                    <div className="relative shrink-0 mt-0.5">
                      <img
                        alt=""
                        className="rounded-full size-8"
                        src="../metronic/media/avatars/300-34.png"
                      />
                      <span className="size-1.5 badge badge-circle bg-gray-400 absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2"></span>
                    </div>
                    <div className="flex flex-col gap-3.5 grow">
                  ...
                  <div className="flex grow gap-2 px-5">
                    <div className="relative shrink-0 mt-0.5">
                      <img
                        alt=""
                        className="rounded-full size-8"
                        src="../metronic/media/avatars/300-29.png"
                      />
                      <span className="size-1.5 badge badge-circle bg-gray-400 absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2"></span>
                    </div>
                          ...
                          <div className="flex -space-x-2">
                            <div className="flex">
                              <img
                                ...
                                src="../metronic/media/avatars/300-3.png"
                              />
                            </div>
                            <div className="flex">
                              <img
                  ...
                  >
                    <div className="relative shrink-0 mt-0.5">
                      <img
                        alt=""
                        className="rounded-full size-8"
                        src="../metronic/media/avatars/300-30.png"
                      />
                      <span className="size-1.5 badge badge-circle bg-gray-400 absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2"></span>
                    </div>
                    <div className="flex flex-col gap-3.5">
                  ...
                  <div className="flex grow gap-2.5 px-5">
                    <div className="relative shrink-0 mt-0.5">
                      <img
                        alt=""
                        className="rounded-full size-8"
                        src="../metronic/media/avatars/300-24.png"
                      />
                      <span className="size-1.5 badge badge-circle badge-success absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2"></span>
                    </div>
                    <div className="flex flex-col gap-1">
                  ...
                  <div className="flex grow gap-2 px-5">
                    <div className="relative shrink-0 mt-0.5">
                      <img
                        alt=""
                        className="rounded-full size-8"
                        src="../metronic/media/avatars/300-15.png"
                      />
                      <span className="size-1.5 badge badge-circle bg-gray-400 absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2"></span>
                    </div>
                    <div
                  ...
                  <div className="flex grow gap-2.5 px-5">
                    <div className="relative shrink-0 mt-0.5">
                      <img
                        alt=""
                        className="rounded-full size-8"
                        src="../metronic/media/avatars/300-6.png"
                      />
                  ...
                  <div className="flex grow gap-2.5 px-5">
                    <div className="relative shrink-0 mt-0.5">
                      <img
                        alt=""
                        className="rounded-full size-8"
                        src="../metronic/media/avatars/300-12.png"
                      />
                      <span className="size-1.5 badge badge-circle badge-success absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2"></span>
                    </div>
                    <div className="flex flex-col gap-3.5 grow">
                  ...
                  <div className="flex grow gap-2.5 px-5">
                    <div className="relative shrink-0 mt-0.5">
                      <img
                        alt=""
                        className="rounded-full size-8"
                        src="../metronic/media/avatars/300-21.png"
                      />
                      <span className="size-1.5 badge badge-circle badge-success absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2"></span>
                    </div>
                    <div className="flex flex-col gap-3.5">
                  ...
                  >
                    <div className="relative shrink-0 mt-0.5">
                      <img
                        alt=""
                        className="rounded-full size-8"
                        src="../metronic/media/avatars/300-13.png"
                      />
                      <span className="size-1.5 badge badge-circle badge-success absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2"></span>
                    </div>
                    <div className="flex flex-col gap-3.5">
                  ...
                  >
                    <div className="relative shrink-0 mt-0.5">
                      <img
                        alt=""
                        className="rounded-full size-8"
                        src="../metronic/media/avatars/300-19.png"
                      />
                      <span className="size-1.5 badge badge-circle badge-success absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2"></span>
                    </div>
                    <div
                  ...
                  <div className="flex grow gap-2.5 px-5">
                    <div className="relative shrink-0 mt-0.5">
                      <img
                        alt=""
                        className="rounded-full size-8"
                        src="../metronic/media/avatars/300-17.png"
                      />
                      <span className="size-1.5 badge badge-circle badge-success absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2"></span>
                    </div>
                    <div className="flex flex-col gap-2.5 grow">
                  ...
                  <div className="flex grow gap-2.5 px-5">
                    <div className="relative shrink-0 mt-0.5">
                      <img
                        alt=""
                        className="rounded-full size-8"
                        src="../metronic/media/avatars/300-9.png"
                      />
                      <span className="size-1.5 badge badge-circle bg-gray-400 absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2"></span>
                    </div>
                    <div className="flex flex-col gap-2.5 grow">
