     ...
     <div className="container-fixed flex justify-between items-stretch lg:gap-4" id="header_container">
      <div className="flex gap-1 lg:hidden items-center -ms-1">
       <a className="shrink-0" href="index.html">
        <img className="max-h-[25px] w-full" src="https://keenthemes.com/static/metronic/tailwind/dist/assets/media/app/mini-logo.svg"/>
       </a>
        ...
        <div className="hidden lg:flex lg:items-stretch" data-drawer="true" data-drawer-class="drawer drawer-start fixed z-10 top-0 bottom-0 w-full me-5 max-w-[250px] p-5 lg:p-0 overflow-auto" data-drawer-enable="true|lg:false" id="mega_menu_wrapper">
         ...
         <div className="menu flex-col lg:flex-row gap-5 lg:gap-7.5" data-menu="true" id="mega_menu">
          ...
          <div className="menu-item active">
           <a className="menu-link text-nowrap text-sm text-gray-800 font-medium menu-item-hover:text-primary menu-item-active:text-gray-900 menu-item-active:font-medium" href="index.html">
             ...
             <div className="grid lg:grid-cols-2 gap-5 lg:gap-10">
               ...
               <div className="grid lg:grid-cols-2 lg:gap-5">
                <div className="flex flex-col">
                 <div className="menu-item">
                  <a className="menu-link" href="public-profile/profiles/default.html" >
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="public-profile/profiles/creator.html" >
                   <span className="menu-icon">
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="public-profile/profiles/company.html" >
                   <span className="menu-icon">
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="public-profile/profiles/nft.html" >
                   <span className="menu-icon">
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="public-profile/profiles/blogger.html" >
                   <span className="menu-icon">
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="public-profile/profiles/crm.html" >
                   <span className="menu-icon">
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="public-profile/profiles/gamer.html" >
                   <span className="menu-icon">
                ...
                <div>
                 <div className="menu-item">
                  <a className="menu-link" href="public-profile/profiles/feeds.html" >
                   <span className="menu-icon">
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="public-profile/profiles/plain.html" >
                   <span className="menu-icon">
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="public-profile/profiles/modal.html" >
                   <span className="menu-icon">
              ...
              <div className="menu menu-default menu-fit flex-col">
               ...
               <div className="grid lg:grid-cols-2 lg:gap-5">
                <div className="flex flex-col">
                 <div className="menu-item">
                  <a className="menu-link" href="public-profile/projects/3-columns.html" >
                   <span className="menu-icon">
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="public-profile/projects/2-columns.html" >
                   <span className="menu-icon">
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="public-profile/works.html" >
                   <span className="menu-icon">
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="public-profile/teams.html" >
                   <span className="menu-icon">
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="public-profile/network.html" >
                   <span className="menu-icon">
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="public-profile/activity.html" >
                   <span className="menu-icon">
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="public-profile/campaigns/card.html" >
                   <span className="menu-icon">
                ...
                <div>
                 <div className="menu-item">
                  <a className="menu-link" href="public-profile/campaigns/list.html" >
                   <span className="menu-icon">
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="public-profile/empty.html" >
                   <span className="menu-icon">
            ...
            <div className="pt-4 pb-2 lg:p-7.5 lg:pb-5 grow">
             <div className="grid lg:grid-cols-5 gap-5">
              <div className="flex flex-col">
               ...
               <div className="menu menu-default menu-fit flex-col">
                <div className="menu-item">
                 <a className="menu-link" href="account/home/get-started.html" >
                  <span className="menu-title grow-0">
                   Get Started
                  </span>
                 </a>
                ...
                <div className="menu-item">
                 <a className="menu-link" href="account/home/user-profile.html" >
                  <span className="menu-title grow-0">
                   User Profile
                  </span>
                 </a>
                ...
                <div className="menu-item">
                 <a className="menu-link" href="account/home/company-profile.html" >
                  <span className="menu-title grow-0">
                   Company Profile
                  </span>
                 </a>
                ...
                <div className="menu-item">
                 <a className="menu-link" href="account/home/settings-sidebar.html" >
                  <span className="menu-title grow-0">
                   With Sidebar
                  </span>
                 </a>
                ...
                <div className="menu-item">
                 <a className="menu-link" href="account/home/settings-enterprise.html" >
                  <span className="menu-title grow-0">
                   Enterprise
                  </span>
                 </a>
                ...
                <div className="menu-item">
                 <a className="menu-link" href="account/home/settings-plain.html" >
                  <span className="menu-title grow-0">
                   Plain
                  </span>
                 </a>
                ...
                <div className="menu-item">
                 <a className="menu-link" href="account/home/settings-modal.html" >
                  <span className="menu-title grow-0">
                   Modal
                  </span>
                 </a>
              ...
              <div className="flex flex-col">
               ...
               <div className="menu menu-default menu-fit flex-col">
                <div className="menu-item">
                 <a className="menu-link" href="account/billing/basic.html" >
                  <span className="menu-title grow-0">
                   Basic Billing
                  </span>
                 </a>
                ...
                <div className="menu-item">
                 <a className="menu-link" href="account/billing/enterprise.html" >
                  <span className="menu-title grow-0">
                   Enterprise
                  </span>
                 </a>
                ...
                <div className="menu-item">
                 <a className="menu-link" href="account/billing/plans.html" >
                  <span className="menu-title grow-0">
                   Plans
                  </span>
                 </a>
                ...
                <div className="menu-item">
                 <a className="menu-link" href="account/billing/history.html" >
                  <span className="menu-title grow-0">
                   Billing History
                  </span>
                 </a>
              ...
              <div className="flex flex-col">
               ...
               <div className="menu menu-default menu-fit flex-col">
                <div className="menu-item">
                 <a className="menu-link" href="account/security/get-started.html" >
                  <span className="menu-title grow-0">
                   Get Started
                  </span>
                 </a>
                ...
                <div className="menu-item">
                 <a className="menu-link" href="account/security/overview.html" >
                  <span className="menu-title grow-0">
                   Security Overview
                  </span>
                 </a>
                ...
                <div className="menu-item">
                 <a className="menu-link" href="account/security/allowed-ip-addresses.html" >
                  <span className="menu-title grow-0">
                   IP Addresses
                  </span>
                 </a>
                ...
                <div className="menu-item">
                 <a className="menu-link" href="account/security/privacy-settings.html" >
                  <span className="menu-title grow-0">
                   Privacy Settings
                  </span>
                 </a>
                ...
                <div className="menu-item">
                 <a className="menu-link" href="account/security/device-management.html" >
                  <span className="menu-title grow-0">
                   Device Management
                  </span>
                 </a>
                ...
                <div className="menu-item">
                 <a className="menu-link" href="account/security/backup-and-recovery.html" >
                  <span className="menu-title grow-0">
                   Backup &amp; Recovery
                  </span>
                 </a>
                ...
                <div className="menu-item">
                 <a className="menu-link" href="account/security/current-sessions.html" >
                  <span className="menu-title grow-0">
                   Current Sessions
                  </span>
                 </a>
                ...
                <div className="menu-item">
                 <a className="menu-link" href="account/security/security-log.html" >
                  <span className="menu-title grow-0">
                   Security Log
                  </span>
                 </a>
              ...
              <div className="flex flex-col">
               ...
               <div className="menu menu-default menu-fit flex-col">
                <div className="menu-item">
                 <a className="menu-link" href="account/members/team-starter.html" >
                  <span className="menu-title grow-0">
                   Teams Starter
                  </span>
                 </a>
                ...
                <div className="menu-item">
                 <a className="menu-link" href="account/members/teams.html" >
                  <span className="menu-title grow-0">
                   Teams
                  </span>
                 </a>
                ...
                <div className="menu-item">
                 <a className="menu-link" href="account/members/team-info.html" >
                  <span className="menu-title grow-0">
                   Team Info
                  </span>
                 </a>
                ...
                <div className="menu-item">
                 <a className="menu-link" href="account/members/members-starter.html" >
                  <span className="menu-title grow-0">
                   Members Starter
                  </span>
                 </a>
                ...
                <div className="menu-item">
                 <a className="menu-link" href="account/members/team-members.html" >
                  <span className="menu-title grow-0">
                   Team Members
                  </span>
                 </a>
                ...
                <div className="menu-item">
                 <a className="menu-link" href="account/members/import-members.html" >
                  <span className="menu-title grow-0">
                   Import Members
                  </span>
                 </a>
                ...
                <div className="menu-item">
                 <a className="menu-link" href="account/members/roles.html" >
                  <span className="menu-title grow-0">
                   Roles
                  </span>
                 </a>
                ...
                <div className="menu-item">
                 <a className="menu-link" href="account/members/permissions-toggle.html" >
                  <span className="menu-title grow-0">
                ...
                <div className="menu-item">
                 <a className="menu-link" href="account/members/permissions-check.html" >
                  <span className="menu-title grow-0">
                   Persmissions - Check
                  </span>
                 </a>
              ...
              <div className="flex flex-col">
               ...
               <div className="menu menu-default menu-fit flex-col">
                <div className="menu-item">
                 <a className="menu-link" href="account/integrations.html" >
                  <span className="menu-title grow-0">
                   Integrations
                  </span>
                 </a>
                ...
                <div className="menu-item">
                 <a className="menu-link" href="account/notifications.html" >
                  <span className="menu-title grow-0">
                   Notifications
                  </span>
                 </a>
                ...
                <div className="menu-item">
                 <a className="menu-link" href="account/appearance.html" >
                  <span className="menu-title grow-0">
                   Appearance
                  </span>
                 </a>
                ...
                <div className="menu-item">
                 <a className="menu-link" href="account/invite-a-friend.html" >
                  <span className="menu-title grow-0">
                   Invite a Friend
                  </span>
                 </a>
             ...
             <div className="pt-4 pb-2 lg:p-7.5 lg:pb-5 grow">
              <div className="grid lg:grid-cols-2 gap-5">
               <div className="flex flex-col gap-5">
                ...
                <div className="menu menu-default menu-fit flex-col">
                 <div className="menu-item">
                  <a className="menu-link" href="network/user-cards/mini-cards.html" >
                   <span className="menu-title grow-0">
                    Mini Cards
                   </span>
                  </a>
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="network/user-cards/team-crew.html" >
                   <span className="menu-title grow-0">
                    Team Crew
                   </span>
                  </a>
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="network/user-cards/nft.html" >
                   <span className="menu-title grow-0">
                    Authors
                   </span>
                  </a>
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="network/user-cards/social.html" >
                   <span className="menu-title grow-0">
                    NFT Users
                   </span>
                  </a>
               ...
               <div className="flex flex-col gap-5">
                ...
                <div className="menu menu-default menu-fit flex-col">
                 <div className="menu-item">
                  <a className="menu-link" href="network/user-table/team-crew.html" >
                   <span className="menu-title grow-0">
                    Team Crew
                   </span>
                  </a>
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="network/user-table/app-roster.html" >
                   <span className="menu-title grow-0">
                    App Roster
                   </span>
                  </a>
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="network/user-table/market-authors.html" >
                   <span className="menu-title grow-0">
                    Market Authors
                   </span>
                  </a>
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="network/user-table/saas-users.html" >
                   <span className="menu-title grow-0">
                    SaaS Users
                   </span>
                  </a>
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="network/user-table/store-clients.html" >
                   <span className="menu-title grow-0">
                    Store Clients
                   </span>
                  </a>
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="network/user-table/visitors.html" >
                   <span className="menu-title grow-0">
                    Visitors
                   </span>
                  </a>
             ...
             <div className="pt-4 pb-2 lg:p-7.5 lg:pb-5 grow">
              <div className="grid lg:grid-cols-2 gap-5">
               <div className="flex flex-col">
                ...
                <div className="menu menu-default menu-fit flex-col">
                 <div className="menu-item">
                  <a className="menu-link" href="authentication/classic/sign-in.html" >
                   <span className="menu-title grow-0">
                    Sign In
                   </span>
                  </a>
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="authentication/classic/sign-up.html" >
                   <span className="menu-title grow-0">
                    Sign Up
                   </span>
                  </a>
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="authentication/classic/2fa.html" >
                   <span className="menu-title grow-0">
                    2FA
                   </span>
                  </a>
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="authentication/classic/check-email.html" >
                   <span className="menu-title grow-0">
                    Check Email
                   </span>
                  </a>
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="authentication/classic/reset-password/enter-email.html" >
                   <span className="menu-title grow-0">
                    Enter Email
                   </span>
                  </a>
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="authentication/classic/reset-password/check-email.html" >
                   <span className="menu-title grow-0">
                    Check Email
                   </span>
                  </a>
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="authentication/classic/reset-password/change-password.html" >
                   <span className="menu-title grow-0">
                    Change Password
                   </span>
                  </a>
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="authentication/classic/reset-password/password-changed.html" >
                   <span className="menu-title grow-0">
                    Password is Changed
                   </span>
                  </a>
               ...
               <div className="flex flex-col">
                ...
                <div className="menu menu-default menu-fit flex-col">
                 <div className="menu-item">
                  <a className="menu-link" href="authentication/branded/sign-in.html" >
                   <span className="menu-title grow-0">
                    Sign In
                   </span>
                  </a>
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="authentication/branded/sign-up.html" >
                   <span className="menu-title grow-0">
                    Sign Up
                   </span>
                  </a>
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="authentication/branded/2fa.html" >
                   <span className="menu-title grow-0">
                    2FA
                   </span>
                  </a>
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="authentication/branded/check-email.html" >
                   <span className="menu-title grow-0">
                    Check Email
                   </span>
                  </a>
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="authentication/branded/reset-password/enter-email.html" >
                   <span className="menu-title grow-0">
                    Enter Email
                   </span>
                  </a>
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="authentication/branded/reset-password/check-email.html" >
                   <span className="menu-title grow-0">
                    Check Email
                   </span>
                  </a>
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="authentication/branded/reset-password/change-password.html" >
                   <span className="menu-title grow-0">
                    Change Password
                   </span>
                  </a>
                 ...
                 <div className="menu-item">
                  <a className="menu-link" href="authentication/branded/reset-password/password-changed.html" >
                   <span className="menu-title grow-0">
                    Password is Changed
                   </span>
                  </a>
          ...
          <div className="menu-item" data-menu-item-offset="0,0|lg:-20px, 0" data-menu-item-offset-rtl="0,0|lg:20px, 0" data-menu-item-overflow="true" data-menu-item-placement="bottom-start" data-menu-item-placement-rtl="bottom-end" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:hover">
           ...
           <div className="menu-dropdown menu-default py-2.5 w-full max-w-[220px]">
            <div className="menu-item">
             <a className="menu-link" href="https://keenthemes.com/metronic/tailwind/docs/getting-started/installation" >
              <span className="menu-icon">
               <i className="ki-filled ki-coffee">
               </i>
              </span>
            ...
            <div className="menu-item" data-menu-item-placement="right-start" data-menu-item-placement-rtl="left-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:hover">
             ...
             <div className="menu-dropdown menu-default w-full max-w-[175px] lg:max-w-[220px]">
              ...
              <div className="menu-item">
               <a className="menu-link" href="https://devs.keenthemes.com/popular" >
                <span className="menu-icon">
              ...
              <div className="menu-item">
               <a className="menu-link" href="https://devs.keenthemes.com/question/create" >
                <span className="menu-icon">
                 <i className="ki-filled ki-message-question">
                 </i>
                </span>
            ...
            <div className="menu-item">
             <a className="menu-link" href="https://keenthemes.com/metronic/tailwind/docs/getting-started/license" >
              <span className="menu-icon">
            ...
            <div className="menu-item">
             <a className="menu-link" href="https://keenthemes.com/metronic/tailwind/docs" >
              <span className="menu-icon">
               <i className="ki-filled ki-questionnaire-tablet">
               </i>
              </span>
            ...
            <div className="menu-item">
             <a className="menu-link" href="https://keenthemes.com/contact" >
              <span className="menu-icon">
      ...
      <div className="flex items-center gap-2 lg:gap-3.5">
       <button className="btn btn-icon btn-icon-lg size-9 rounded-full hover:bg-primary-light hover:text-primary text-gray-500" data-modal-toggle="#search_modal">
        <i className="ki-filled ki-magnifier">
        </i>
       </button>
       <div className="dropdown" data-dropdown="true" data-dropdown-offset="170px, 10px" data-dropdown-offset-rtl="-170px, 10px" data-dropdown-placement="bottom-end" data-dropdown-placement-rtl="bottom-start" data-dropdown-trigger="click|lg:click">
        ...
        <div className="dropdown-content light:border-gray-300 w-screen max-w-[450px]">
         <div>
          <div className="flex items-center justify-between gap-2.5 text-sm text-gray-900 font-semibold px-5 py-2.5">
           Chat
           <button className="btn btn-sm btn-icon btn-light btn-clear shrink-0" data-dropdown-dismiss="true">
           ...
           <div className="flex items-center justify-between flex-wrap gap-2 px-5">
            <div className="flex items-center flex-wrap gap-2">
             <div className="flex items-center justify-center shrink-0 rounded-full bg-gray-100 border border-gray-200 size-11">
              <img alt="" className="size-7" src="https://keenthemes.com/static/metronic/tailwind/dist/assets/media/brand-logos/gitlab.svg"/>
             </div>
             <div className="flex flex-col">
            ...
            <div className="flex items-center gap-2.5">
             <div className="flex -space-x-2">
              <div className="flex">
               <img className="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-4.png"/>
              </div>
              <div className="flex">
               <img className="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-1.png"/>
              </div>
              <div className="flex">
               <img className="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-[30px]" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-2.png"/>
              </div>
              <div className="flex">
             ...
             <div className="menu" data-menu="true">
              <div className="menu-item" data-menu-item-offset="0, 10px" data-menu-item-placement="bottom-end" data-menu-item-placement-rtl="bottom-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:hover">
                ...
                <div className="menu-item" data-menu-item-offset="-15px, 0" data-menu-item-placement="right-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:hover">
                 ...
                 <div className="menu-dropdown menu-default w-full max-w-[175px]">
                  <div className="menu-item">
                   <a className="menu-link" href="account/members/import-members.html">
                    <span className="menu-icon">
                     <i className="ki-filled ki-shield-search">
                     </i>
                    </span>
                    <span className="menu-title">
                     Find Members
                  ...
                  <div className="menu-item">
                   <a className="menu-link" href="account/members/import-members.html">
                    <span className="menu-icon">
                     <i className="ki-filled ki-filter-edit">
                     </i>
                    </span>
                    <span className="menu-title">
                     Group Settings
         ...
         <div className="scrollable-y-auto" data-scrollable="true" data-scrollable-dependencies="#header" data-scrollable-max-height="auto" data-scrollable-offset="280px">
          <div className="flex flex-col gap-5 py-5">
           <div className="flex items-end gap-3.5 px-5">
            <img alt="" className="rounded-full size-9" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-5.png"/>
            <div className="flex flex-col gap-1.5">
           ...
           <div className="flex items-end justify-end gap-3.5 px-5">
            ...
            <div className="relative shrink-0">
             <img alt="" className="rounded-full size-9" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-2.png"/>
             <span className="size-[4.8px] badge badge-circle badge-success absolute top-7 end-0 transform -translate-y-1/2">
             </span>
            </div>
           </div>
           <div className="flex items-end gap-3.5 px-5">
            <img alt="" className="rounded-full size-9" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-4.png"/>
            <div className="flex flex-col gap-1.5">
             <div className="card shadow-none flex flex-col bg-gray-100 gap-2.5 p-3 rounded-bl-none">
              <p className="text-2sm font-medium text-gray-700">
           ...
           <div className="flex items-end gap-3.5 px-5">
            <img alt="" className="rounded-full size-9" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-1.png"/>
            <div className="flex flex-col gap-1.5">
             <div className="card shadow-none flex flex-col bg-gray-100 gap-2.5 p-3 rounded-bl-none">
              <p className="text-2sm font-medium text-gray-700">
         ...
         <div className="mb-2.5">
          <div className="flex grow gap-2 p-5 bg-gray-100 mb-2.5" id="join_request">
           <div className="relative shrink-0">
            <img alt="" className="rounded-full size-8" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-14.png"/>
            <span className="size-1.5 badge badge-circle bg-gray-400 absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">
            </span>
           </div>
           <div className="flex items-center justify-between gap-3 grow">
            <div className="flex flex-col">
             <div className="text-2sm mb-px">
              <a className="hover:text-primary-active font-semibold text-gray-900" href="#">
               Jane Perez
              </a>
             ...
             <span className="flex items-center text-2xs font-medium text-gray-500">
              1 day ago
              <span className="badge badge-circle bg-gray-500 size-1 mx-1.5">
              </span>
              Design Team
             </span>
            </div>
          ...
          <div className="relative grow mx-5">
           <img alt="" className="rounded-full size-[30px] absolute start-0 top-2/4 -translate-y-2/4 ms-2.5" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-2.png"/>
           <input className="input h-auto py-4 ps-12 bg-transparent" placeholder="Write a message..." type="text" value=""/>
           <div className="flex items-center gap-2.5 absolute end-3 top-1/2 -translate-y-1/2">
            <button className="btn btn-sm btn-icon btn-light btn-clear">
             <i className="ki-filled ki-exit-up">
             </i>
            </button>
       ...
       <div className="dropdown" data-dropdown="true" data-dropdown-offset="10px, 10px" data-dropdown-offset-rtl="-10px, 10px" data-dropdown-placement="bottom-end" data-dropdown-placement-rtl="bottom-start" data-dropdown-trigger="click|lg:click">
        <button className="dropdown-toggle btn btn-icon btn-icon-lg size-9 rounded-full hover:bg-primary-light hover:text-primary dropdown-open:bg-primary-light dropdown-open:text-primary text-gray-500">
         <i className="ki-filled ki-element-11">
         </i>
        </button>
        <div className="dropdown-content light:border-gray-300 w-screen max-w-[320px]">
         ...
         <div className="flex flex-col scrollable-y-auto max-h-[400px] divide-y divide-gray-200">
          <div className="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
           <div className="flex items-center flex-wrap gap-2">
            <div className="flex items-center justify-center shrink-0 rounded-full bg-gray-100 border border-gray-200 size-10">
             <img alt="" className="size-6" src="https://keenthemes.com/static/metronic/tailwind/dist/assets/media/brand-logos/jira.svg"/>
            </div>
            <div className="flex flex-col">
             <a className="text-2sm font-semibold text-gray-900 hover:text-primary-active" href="#">
              Jira
          ...
          <div className="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
           <div className="flex items-center flex-wrap gap-2">
            <div className="flex items-center justify-center shrink-0 rounded-full bg-gray-100 border border-gray-200 size-10">
             <img alt="" className="size-6" src="https://keenthemes.com/static/metronic/tailwind/dist/assets/media/brand-logos/inferno.svg"/>
            </div>
            <div className="flex flex-col">
             <a className="text-2sm font-semibold text-gray-900 hover:text-primary-active" href="#">
              Inferno
          ...
          <div className="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
           <div className="flex items-center flex-wrap gap-2">
            <div className="flex items-center justify-center shrink-0 rounded-full bg-gray-100 border border-gray-200 size-10">
             <img alt="" className="size-6" src="https://keenthemes.com/static/metronic/tailwind/dist/assets/media/brand-logos/evernote.svg"/>
            </div>
            <div className="flex flex-col">
             <a className="text-2sm font-semibold text-gray-900 hover:text-primary-active" href="#">
              Evernote
          ...
          <div className="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
           <div className="flex items-center flex-wrap gap-2">
            <div className="flex items-center justify-center shrink-0 rounded-full bg-gray-100 border border-gray-200 size-10">
             <img alt="" className="size-6" src="https://keenthemes.com/static/metronic/tailwind/dist/assets/media/brand-logos/gitlab.svg"/>
            </div>
            <div className="flex flex-col">
             <a className="text-2sm font-semibold text-gray-900 hover:text-primary-active" href="#">
              Gitlab
          ...
          <div className="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
           <div className="flex items-center flex-wrap gap-2">
            <div className="flex items-center justify-center shrink-0 rounded-full bg-gray-100 border border-gray-200 size-10">
             <img alt="" className="size-6" src="https://keenthemes.com/static/metronic/tailwind/dist/assets/media/brand-logos/google-webdev.svg"/>
            </div>
            <div className="flex flex-col">
             <a className="text-2sm font-semibold text-gray-900 hover:text-primary-active" href="#">
              Google webdev
         ...
         <div className="grid p-5 border-t border-t-gray-200">
          <a className="btn btn-sm btn-light justify-center" href="account/api-keys.html">
           Go to Apps
          </a>
         </div>
        </div>
       </div>
       <div className="dropdown" data-dropdown="true" data-dropdown-offset="70px, 10px" data-dropdown-offset-rtl="-70px, 10px" data-dropdown-placement="bottom-end" data-dropdown-placement-rtl="bottom-start" data-dropdown-trigger="click|lg:click">
        ...
        <div className="dropdown-content light:border-gray-300 w-full max-w-[460px]">
         <div className="flex items-center justify-between gap-2.5 text-sm text-gray-900 font-semibold px-5 py-2.5 border-b border-b-gray-200" id="notifications_header">
          Notifications
          <button className="btn btn-sm btn-icon btn-light btn-clear shrink-0" data-dropdown-dismiss="true">
           <i className="ki-filled ki-cross">
           </i>
         ...
         <div className="tabs justify-between px-5 mb-2" data-tabs="true" id="notifications_tabs">
          <div className="flex items-center gap-5">
           <button className="tab active" data-tab-toggle="#notifications_tab_all">
            All
           </button>
           <button className="tab relative" data-tab-toggle="#notifications_tab_inbox">
            Inbox
            <span className="badge badge-dot badge-success size-[5px] absolute top-2 rtl:start-0 end-0 transform translate-y-1/2 translate-x-full">
            </span>
           </button>
           <button className="tab" data-tab-toggle="#notifications_tab_team">
            Team
           </button>
           <button className="tab" data-tab-toggle="#notifications_tab_following">
            Following
           </button>
          </div>
          <div className="menu" data-menu="true">
         ...
         <div className="grow" id="notifications_tab_all">
          <div className="flex flex-col">
           <div className="scrollable-y-auto" data-scrollable="true" data-scrollable-dependencies="#header" data-scrollable-max-height="auto" data-scrollable-offset="200px">
            <div className="flex flex-col gap-5 pt-3 pb-4 divider-y divider-gray-200">
             <div className="flex grow gap-2.5 px-5">
              <div className="relative shrink-0 mt-0.5">
               <img alt="" className="rounded-full size-8" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-4.png"/>
               <span className="size-1.5 badge badge-circle badge-success absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">
               </span>
              </div>
              <div className="flex flex-col gap-3.5">
               <div className="flex flex-col gap-1">
                <div className="text-2sm font-medium">
                 <a className="hover:text-primary-active text-gray-900 font-semibold" href="#">
                  Joe Lincoln
                 </a>
                 <span className="text-gray-700">
                  mentioned you in
                 </span>
                 <a className="hover:text-primary-active text-primary" href="#">
                  Latest Trends
                 </a>
                 <span className="text-gray-700">
                  topic
                ...
                <label className="input input-sm">
                 <input placeholder="Reply" type="text" value="">
                  <button className="btn btn-icon">
                   <i className="ki-filled ki-picture">
                   </i>
                  </button>
                 </input>
                </label>
             ...
             <div className="flex grow gap-2.5 px-5">
              <div className="relative shrink-0 mt-0.5">
               <img alt="" className="rounded-full size-8" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-5.png"/>
               <span className="size-1.5 badge badge-circle badge-success absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">
               </span>
              </div>
              <div className="flex flex-col gap-3.5">
             ...
             <div className="flex grow gap-2.5 px-5" id="notification_request_3">
              <div className="relative shrink-0 mt-0.5">
               <img alt="" className="rounded-full size-8" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-27.png"/>
               <span className="size-1.5 badge badge-circle bg-gray-400 absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">
               </span>
              </div>
              <div className="flex flex-col gap-3.5">
               ...
               <div className="flex flex-wrap gap-2.5">
                <button className="btn btn-light btn-sm" data-dismiss="#notification_request_3">
                 Decline
                </button>
                <button className="btn btn-dark btn-sm" data-dismiss="#notification_request_3">
                 Accept
                </button>
               </div>
              </div>
             ...
             <div className="flex grow gap-2.5 px-5">
              <div className="relative shrink-0 mt-0.5">
               <img alt="" className="rounded-full size-8" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-1.png"/>
               <span className="size-1.5 badge badge-circle bg-gray-400 absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">
               </span>
              </div>
              <div className="flex flex-col gap-3.5 grow">
               ...
               <div className="card shadow-none flex items-center flex-row gap-1.5 p-2.5 rounded-lg bg-light-active">
                <img className="h-5" src="https://keenthemes.com/static/metronic/tailwind/dist/assets/media/file-types/pdf.svg"/>
                <a className="hover:text-primary-active font-medium text-gray-700 text-xs me-1" href="#">
                 Launch_nov24.pptx
                </a>
             ...
             <div className="flex grow gap-2.5 px-5">
              <div className="relative shrink-0 mt-0.5">
               <img alt="" className="rounded-full size-8" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-11.png"/>
               <span className="size-1.5 badge badge-circle badge-success absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">
               </span>
              </div>
              <div className="flex flex-col gap-1">
              ...
              <div className="flex flex-col gap-3.5 grow">
               ...
               <div className="card shadow-none flex items-center flex-row gap-1.5 p-2.5 rounded-lg bg-light-active">
                <div className="flex items-center justify-center w-[26px] h-[30px] shrink-0 bg-light rounded border border-gray-200">
                 <img className="h-5" src="https://keenthemes.com/static/metronic/tailwind/dist/assets/media/file-types/figma.svg"/>
                </div>
                <a className="hover:text-primary-active font-medium text-gray-700 text-xs me-1" href="#">
                 Launcher-UIkit.fig
                </a>
          ...
          <div className="flex flex-col">
           <div className="scrollable-y-auto" data-scrollable="true" data-scrollable-dependencies="#header" data-scrollable-max-height="auto" data-scrollable-offset="200px">
            <div className="flex flex-col gap-5 pt-3 pb-4">
             <div className="flex grow gap-2.5 px-5" id="notification_request_13">
              <div className="relative shrink-0 mt-0.5">
               <img alt="" className="rounded-full size-8" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-25.png"/>
               <span className="size-1.5 badge badge-circle badge-success absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">
               </span>
              </div>
              <div className="flex flex-col gap-3.5 grow">
               <div className="flex flex-col gap-1">
                <div className="text-2sm font-medium mb-px">
                 ...
                 <a className="hover:text-primary-active text-primary font-semibold" href="#">
                  TechSynergy
                 </a>
                </div>
                <span className="flex items-center text-2xs font-medium text-gray-500">
               ...
               <div className="card shadow-none flex items-center flex-row justify-between gap-1.5 px-2.5 py-2 rounded-lg bg-light-active">
                <div className="flex flex-col">
                 <a className="hover:text-primary-active font-medium text-gray-900 text-xs" href="#">
                  Ronald Richards
                 </a>
                 <a className="hover:text-primary-active text-gray-500 font-medium text-3xs" href="#">
                  ronald.richards@gmail.com
                 </a>
                </div>
                <a className="hover:text-primary-active text-gray-700 font-medium text-xs" href="#">
                 Go to profile
                </a>
               </div>
               <div className="flex flex-wrap gap-2.5">
                <button className="btn btn-light btn-sm" data-dismiss="#notification_request_13">
                 Decline
                </button>
                <button className="btn btn-dark btn-sm" data-dismiss="#notification_request_13">
                 Accept
                </button>
               </div>
              </div>
             ...
             <div className="flex items-center grow gap-2.5 px-5">
              <div className="flex items-center justify-center size-8 bg-success-light rounded-full border border-success-clarity">
               <i className="ki-filled ki-check text-lg text-success">
               </i>
              </div>
              <div className="flex flex-col gap-1">
             ...
             <div className="flex grow gap-2.5 px-5">
              <div className="relative shrink-0 mt-0.5">
               <img alt="" className="rounded-full size-8" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-34.png"/>
               <span className="size-1.5 badge badge-circle bg-gray-400 absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">
               </span>
              </div>
              <div className="flex flex-col gap-3.5 grow">
               ...
               <div className="card shadow-none flex items-center justify-between flex-row gap-1.5 p-2.5 rounded-lg bg-light-active">
                <div className="flex items-center gap-1.5">
                 <img className="h-6" src="https://keenthemes.com/static/metronic/tailwind/dist/assets/media/file-types/xls.svg"/>
                 <div className="flex flex-col gap-0.5">
                  <a className="hover:text-primary-active font-medium text-gray-700 text-xs" href="#">
                   Redesign-2024.xls
                  </a>
                  <span className="font-medium text-gray-500 text-2xs">
                   2.6 MB
             ...
             <div className="flex grow gap-2 px-5">
              <div className="relative shrink-0 mt-0.5">
               <img alt="" className="rounded-full size-8" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-29.png"/>
               <span className="size-1.5 badge badge-circle bg-gray-400 absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">
               </span>
              </div>
              <div className="flex flex-col gap-3 grow">
               ...
               <div className="card shadow-none p-3.5 gap-3.5 rounded-lg bg-light-active">
                <div className="flex items-center justify-between flex-wrap gap-2.5">
                 ...
                 <div className="flex -space-x-2">
                  <div className="flex">
                   <img className="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-6" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-3.png"/>
                  </div>
                  <div className="flex">
                   <img className="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-6" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-2.png"/>
                  </div>
                 </div>
                </div>
                <div className="flex items-center gap-2.5">
             ...
             <div className="flex grow gap-2.5 px-5" id="notification_request_3">
              <div className="relative shrink-0 mt-0.5">
               <img alt="" className="rounded-full size-8" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-30.png"/>
               <span className="size-1.5 badge badge-circle bg-gray-400 absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">
               </span>
              </div>
              <div className="flex flex-col gap-3.5">
             ...
             <div className="flex grow gap-2.5 px-5">
              <div className="relative shrink-0 mt-0.5">
               <img alt="" className="rounded-full size-8" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-24.png"/>
               <span className="size-1.5 badge badge-circle badge-success absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">
               </span>
              </div>
              <div className="flex flex-col gap-1">
           ...
           <div className="grid grid-cols-2 p-5 gap-2.5" id="notifications_inbox_footer">
            <button className="btn btn-sm btn-light justify-center">
             Archive all
            </button>
            <button className="btn btn-sm btn-light justify-center">
          ...
          <div className="flex flex-col">
           <div className="scrollable-y-auto" data-scrollable="true" data-scrollable-dependencies="#header" data-scrollable-max-height="auto" data-scrollable-offset="200px">
            <div className="flex flex-col gap-5 pt-3 pb-4">
             <div className="flex grow gap-2 px-5">
              <div className="relative shrink-0 mt-0.5">
               <img alt="" className="rounded-full size-8" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-15.png"/>
               <span className="size-1.5 badge badge-circle bg-gray-400 absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">
               </span>
              </div>
              <div className="flex flex-col gap-3 grow" id="notification_request_10">
               <div className="flex flex-col gap-1">
                <div className="text-2sm font-medium mb-px">
                 <a className="hover:text-primary-active text-gray-900 font-semibold" href="#">
                  Nova Hawthorne
               ...
               <div className="card shadow-none p-2.5 rounded-lg bg-light-active">
                <div className="flex items-center justify-between flex-wrap gap-2.5">
                 ...
                 <div className="flex -space-x-2">
                  <div className="flex">
                   <img className="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-6" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-4.png"/>
                  </div>
                  <div className="flex">
                   <img className="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-6" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-1.png"/>
                  </div>
                  <div className="flex">
                   <img className="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-6" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-2.png"/>
                  </div>
               ...
               <div className="flex flex-wrap gap-2.5">
                <button className="btn btn-light btn-sm" data-dismiss="#notification_request_10">
                 Decline
                </button>
                <button className="btn btn-dark btn-sm" data-dismiss="#notification_request_10">
                 Accept
                </button>
               </div>
              </div>
             ...
             <div className="flex grow gap-2.5 px-5">
              <div className="relative shrink-0 mt-0.5">
               <img alt="" className="rounded-full size-8" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-6.png"/>
               <span className="size-1.5 badge badge-circle absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">
               </span>
              </div>
              <div className="flex flex-col gap-1">
               <div className="text-2sm font-medium mb-px">
             ...
             <div className="flex grow gap-2.5 px-5">
              <div className="relative shrink-0 mt-0.5">
               <img alt="" className="rounded-full size-8" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-12.png"/>
               <span className="size-1.5 badge badge-circle badge-success absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">
               </span>
              </div>
              <div className="flex flex-col gap-3.5 grow">
               ...
               <div className="card shadow-none flex items-center justify-between flex-row gap-1.5 p-2.5 rounded-lg bg-light-active">
                <div className="flex items-center gap-1.5">
                 <img className="h-6" src="https://keenthemes.com/static/metronic/tailwind/dist/assets/media/file-types/word.svg"/>
                 <div className="flex flex-col gap-0.5">
                  <a className="hover:text-primary-active font-medium text-gray-700 text-xs" href="#">
                   Landing-page.docx
                  </a>
               ...
               <div className="card shadow-none flex items-center justify-between flex-row gap-1.5 p-2.5 rounded-lg bg-light-active">
                <div className="flex items-center gap-1.5">
                 <img className="h-6" src="https://keenthemes.com/static/metronic/tailwind/dist/assets/media/file-types/svg.svg"/>
                 <div className="flex flex-col gap-0.5">
                  <a className="hover:text-primary-active font-medium text-gray-700 text-xs" href="#">
                   New-icon.svg
                  </a>
             ...
             <div className="flex grow gap-2.5 px-5">
              <div className="relative shrink-0 mt-0.5">
               <img alt="" className="rounded-full size-8" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-21.png"/>
               <span className="size-1.5 badge badge-circle badge-success absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">
               </span>
              </div>
              <div className="flex flex-col gap-3.5">
             ...
             <div className="flex grow gap-2.5 px-5" id="notification_request_3">
              <div className="relative shrink-0 mt-0.5">
               <img alt="" className="rounded-full size-8" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-13.png"/>
               <span className="size-1.5 badge badge-circle badge-success absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">
               </span>
              </div>
              <div className="flex flex-col gap-3.5">
           ...
           <div className="grid grid-cols-2 p-5 gap-2.5" id="notifications_team_footer">
            <button className="btn btn-sm btn-light justify-center">
             Archive all
            </button>
            <button className="btn btn-sm btn-light justify-center">
          ...
          <div className="flex flex-col">
           <div className="scrollable-y-auto" data-scrollable="true" data-scrollable-dependencies="#header" data-scrollable-max-height="auto" data-scrollable-offset="200px">
            <div className="flex flex-col gap-5 pt-3 pb-4">
              ...
              <div className="flex flex-col gap-2.5 grow">
               ...
               <div className="flex items-center gap-2.5">
                <div className="card shadow-none flex flex-col gap-3.5 bg-light-active w-40">
                 <div className="bg-cover bg-no-repeat card-rounded-t shrink-0 h-24" style="background-image: url('../../../static/metronic/tailwind/dist/assets/media/images/600x600/6.jpg')">
                 </div>
                 <div className="px-2.5 pb-2">
                  <a className="font-medium block text-gray-700 hover:text-primary text-xs leading-4 mb-0.5" href="#">
                   Geometric Patterns
                  </a>
                ...
                <div className="card shadow-none flex flex-col gap-3.5 bg-light-active w-40">
                 <div className="bg-cover bg-no-repeat card-rounded-t shrink-0 h-24" style="background-image: url('../../../static/metronic/tailwind/dist/assets/media/images/600x600/1.jpg')">
                 </div>
                 <div className="px-2.5 pb-2">
                  <a className="font-medium block text-gray-700 hover:text-primary text-xs leading-4 mb-0.5" href="#">
             ...
             <div className="flex grow gap-2.5 px-5" id="notification_request_17">
              <div className="relative shrink-0 mt-0.5">
               <img alt="" className="rounded-full size-8" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-19.png"/>
               <span className="size-1.5 badge badge-circle badge-success absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">
               </span>
              </div>
              <div className="flex flex-col gap-2.5 grow">
               ...
               <div className="card shadow-none flex items-center flex-row gap-1.5 p-2.5 rounded-lg bg-light-active">
                <div className="flex items-center justify-center w-[26px] h-[30px] shrink-0 bg-white rounded border border-gray-200">
                 <img className="h-5" src="https://keenthemes.com/static/metronic/tailwind/dist/assets/media/brand-logos/jira.svg"/>
                </div>
                <a className="hover:text-primary-active font-medium text-gray-700 text-xs me-1" href="#">
                 User-feedback.jira
                </a>
               ...
               <div className="flex flex-wrap gap-2.5">
                <button className="btn btn-light btn-sm" data-dismiss="#notification_request_17">
                 Decline
                </button>
                <button className="btn btn-dark btn-sm" data-dismiss="#notification_request_17">
                 Accept
                </button>
               </div>
              </div>
             ...
             <div className="flex grow gap-2.5 px-5">
              <div className="relative shrink-0 mt-0.5">
               <img alt="" className="rounded-full size-8" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-17.png"/>
               <span className="size-1.5 badge badge-circle badge-success absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">
               </span>
              </div>
              <div className="flex flex-col gap-2.5 grow">
               ...
               <div className="card shadow-none flex items-center flex-row gap-1.5 px-2.5 py-1.5 rounded-lg bg-light-active">
                <i className="ki-filled ki-user-tick text-success text-base">
                </i>
             ...
             <div className="flex grow gap-2.5 px-5">
              <div className="relative shrink-0 mt-0.5">
               <img alt="" className="rounded-full size-8" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-9.png"/>
               <span className="size-1.5 badge badge-circle bg-gray-400 absolute top-7 end-0.5 ring-1 ring-light transform -translate-y-1/2">
               </span>
              </div>
              <div className="flex flex-col gap-2.5 grow">
               ...
               <div className="flex flex-wrap gap-2.5">
                <button className="btn btn-sm btn-light">
                 <i className="ki-filled ki-check-circle">
                 </i>
                 Connected
                </button>
           ...
           <div className="grid grid-cols-2 p-5 gap-2.5" id="notifications_following_footer">
            <button className="btn btn-sm btn-light justify-center">
             Archive all
            </button>
            <button className="btn btn-sm btn-light justify-center">
       ...
       <div className="menu" data-menu="true">
        <div className="menu-item" data-menu-item-offset="20px, 10px" data-menu-item-offset-rtl="-20px, 10px" data-menu-item-placement="bottom-end" data-menu-item-placement-rtl="bottom-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:click">
         <div className="menu-toggle btn btn-icon rounded-full">
          <img alt="" className="size-9 rounded-full border-2 border-success shrink-0" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-2.png">
          </img>
         </div>
         <div className="menu-dropdown menu-default light:border-gray-300 w-screen max-w-[250px]">
          <div className="flex items-center justify-between px-5 py-1.5 gap-1.5">
           <div className="flex items-center gap-2">
            <img alt="" className="size-9 rounded-full border-2 border-success" src="../../../static/metronic/tailwind/dist/assets/media/avatars/300-2.png">
             <div className="flex flex-col gap-1.5">
              <span className="text-sm text-gray-800 font-semibold leading-none">
               Cody Fisher
              </span>
              <a className="text-xs text-gray-600 hover:text-primary font-medium leading-none" href="account/home/get-started.html">
               c.fisher@gmail.com
              </a>
             </div>
            </img>
           ...
           <div className="menu-item" data-menu-item-offset="-10px, 0" data-menu-item-placement="left-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:hover">
            <div className="menu-link">
             ...
             <div className="flex items-center gap-1.5 rounded-md border border-gray-300 text-gray-600 p-1.5 text-2xs font-medium shrink-0">
              English
              <img alt="" className="inline-block size-3.5 rounded-full" src="https://keenthemes.com/static/metronic/tailwind/dist/assets/media/flags/united-states.svg"/>
             </div>
            </div>
            <div className="menu-dropdown menu-default light:border-gray-300 w-full max-w-[170px]">
             <div className="menu-item active">
              <a className="menu-link h-10" href="indexe3ae.html?dir=ltr">
               <span className="menu-icon">
                <img alt="" className="inline-block size-4 rounded-full" src="https://keenthemes.com/static/metronic/tailwind/dist/assets/media/flags/united-states.svg"/>
               </span>
               <span className="menu-title">
                English
               </span>
             ...
             <div className="menu-item">
              <a className="menu-link h-10" href="index347d.html?dir=rtl">
               <span className="menu-icon">
                <img alt="" className="inline-block size-4 rounded-full" src="https://keenthemes.com/static/metronic/tailwind/dist/assets/media/flags/saudi-arabia.svg"/>
               </span>
               <span className="menu-title">
                Arabic(Saudi)
               </span>
             ...
             <div className="menu-item">
              <a className="menu-link h-10" href="indexe3ae.html?dir=ltr">
               <span className="menu-icon">
                <img alt="" className="inline-block size-4 rounded-full" src="https://keenthemes.com/static/metronic/tailwind/dist/assets/media/flags/spain.svg"/>
               </span>
               <span className="menu-title">
                Spanish
               </span>
             ...
             <div className="menu-item">
              <a className="menu-link h-10" href="indexe3ae.html?dir=ltr">
               <span className="menu-icon">
                <img alt="" className="inline-block size-4 rounded-full" src="https://keenthemes.com/static/metronic/tailwind/dist/assets/media/flags/germany.svg"/>
               </span>
               <span className="menu-title">
                German
               </span>
             ...
             <div className="menu-item">
              <a className="menu-link h-10" href="indexe3ae.html?dir=ltr">
               <span className="menu-icon">
                <img alt="" className="inline-block size-4 rounded-full" src="https://keenthemes.com/static/metronic/tailwind/dist/assets/media/flags/japan.svg"/>
               </span>
               <span className="menu-title">
                Japanese
               </span>
          ...
          <div className="flex flex-col">
           ...
           <div className="menu-item px-4 py-1.5">
            <a className="btn btn-sm btn-light justify-center" href="authentication/classic/sign-in.html">
             Log out
            </a>
           </div>
          </div>
